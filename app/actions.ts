...
export async function BuyProducts(formData: FormData){
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        success_url: process.env.NODE_ENV === "development" ? "http://localhost:3000/payment/success" : "https://marketplace-ui-jade.vercel.app/payment/success",
        cancel_url: process.env.NODE_ENV === "development" ? 'http://localhost:3000/payment/cancel' : "https://marketplace-ui-jade.vercel.app/payment/cancel",
    });
...
export async function CreateStripeAccountLink(){
    ...
    const accountLink = await stripe.accountLinks.create({
        ...
        refresh_url: process.env.NODE_ENV === "development" ? `http://localhost:3000/billing` : `https://marketplace-ui-jade.vercel.app/billing`,
        return_url: process.env.NODE_ENV === "development" ? `http://localhost:3000/return/${data?.connectedAccountId}` : `https://marketplace-ui-jade.vercel.app/return/${data?.connectedAccountId}`,
